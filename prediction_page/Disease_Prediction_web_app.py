...
loaded_model=pickle.load(open('C:/Users/Rushil/Desktop/Hackathon/predictionpage/trained_model.sav','rb'))

symptom_descriptions = pd.read_csv('C:/Users/Rushil/Desktop/Hackathon/predictionpage/symptom_Description.csv',names=['Disease', 'Description'])

symptom_precautions = pd.read_csv('C:/Users/Rushil/Desktop/Hackathon/predictionpage/symptom_precaution.csv', names=['Disease', 'Precaution1', 'Precaution2', 'Precaution3', 'Precaution4'])
...
def main():
    ...
    with open('C:/Users/Rushil/Desktop/Hackathon/predictionpage/style.css') as f:
        css=f.read()
